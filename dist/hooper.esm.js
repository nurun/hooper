...
function renderSlides(h) {
  var children = normalizeChildren(this, this.$data);
  ...
  computed: {
    style: function style() {
      var _ref = this.$hooper || {},
        ...
        slideWidth = _ref.slideWidth; // Don't append any styles from server side.
...
var Pagination = {
  ...
  render: function render(h) {
    ...
    var totalCount = this.$hooper.slidesCount - this.$hooper.trimStart - this.$hooper.trimEnd + 1;
    var children =
      this.mode === 'indicator'
