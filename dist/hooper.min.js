  ...
  (i = function(t, i) {
    ...
    function n(i, e) {
      (this.create = function() {
        ...
        (this.set = function(t) {
          this.timer = window.setTimeout(i, t || e);
        }),
      ...
      function(t) {
        ...
        for (var i = Object(t), e = 1; e < arguments.length; e++)
          if (null != (r = arguments[e]))
            for (var r = Object(r), o = Object.keys(Object(r)), n = 0, s = o.length; n < s; n++) {
              var a = o[n],
      ...
      g = {
        ...
        computed: {
          ...
          trackTransform: function() {
            var t = this.config,
              ...
              r = t.rtl,
              o = t.centerMode,
              n = e ? this.slideHeight : this.slideWidth,
              t = e ? this.containerHeight : this.containerWidth,
              n =
                (e ? this.delta.y : this.delta.x) +
                (r ? -1 : 1) * ((o ? (t - n) / 2 : 0) - (i ? n * this.slidesCount : 0) - this.currentSlide * n);
            return e ? 'transform: translate(0, '.concat(n, 'px);') : 'transform: translate('.concat(n, 'px, 0);');
          },
        ...
        methods: {
          slideTo: function(t) {
            ...
            this.isSliding ||
              t === this.currentSlide ||
              ((s = (n = this.config).infiniteScroll),
              (i = n.transition),
              (e = this.currentSlide),
              (r = s
                ? t
                : ((o = t), (n = this.trimStart), (s = this.slidesCount - this.trimEnd), Math.max(Math.min(o, s), n))),
              this.$emit('beforeSlide', { currentSlide: this.currentSlide, slideTo: r }),
              this.group && h && f.$emit('slideGroup:'.concat(this.group), t),
              (this.currentSlide = r),
              (this.isSliding = !0),
              window.setTimeout(function() {
                (a.isSliding = !1), (a.currentSlide = u(r, a.slidesCount));
              }, i),
          ...
          onTransitionend: function(t) {
            t.target.classList.contains('hooper-track') &&
          ...
          onWheel: function(t) {
            t.preventDefault(),
              e() - this.lastScrollTime < 200 ||
                ...
                (t = t.wheelDelta || -t.deltaY),
                -1 === (t = a(t)) && this.slideNext(),
                1 === t && this.slidePrev());
          },
        ...
        render: function(t) {
          var i = this,
            e = function(t) {
              var i = function(t) {
                  for (var i = p(this, this.$data), e = i.length, r = 0, o = [], n = 0; n < e; n++) {
                    var s = i[n],
                  ...
                  (this.slidesCount = o.length),
                    this.config.infiniteScroll &&
                      (o = (function(t, i) {
                        for (var e = [], r = [], o = i.length, n = 0; n < o; n++) {
                          var s = i[n],
                            a = d(t, s),
                            h = n - o;
                          (a.data.key = 'before_'.concat(n)),
                            (a.key = a.data.key),
    ...
    var w = {
      ...
      render: function(t) {
        var i,
          ...
          r,
          o = this,
          n = this.$hooper.slidesCount - this.$hooper.trimStart - this.$hooper.trimEnd + 1,
          r =
            'indicator' === this.mode
              ? $(t, this.currentSlide, n, function(t) {
                  return o.$hooper.slideTo(t);
                })
              : ((i = t), (e = this.currentSlide), (r = n), [i('span', e + 1), i('span', '/'), i('span', r)]);
        return t('div', { class: { 'hooper-pagination': !0, 'is-vertical': this.$hooper.config.vertical } }, r);
      }
    };
    function b(t, i, e, r, o, n) {
      var s,
        a = o.isVertical,
        o = o.isRTL,
        s =
      ...
      return t(
        'button',
        {
          class: (l((t = {}), 'hooper-'.concat(r ? 'prev' : 'next'), !0), l(t, 'is-disabled', i), t),
          attrs: { type: 'button' },
          on: { click: n }
        },
        s
